...
# def handle_connect():
#     if len(clients) < 2:
#         client_id = 'client1' if 'client1' not in clients else 'client2'
#         clients[client_id] = request.sid
#         print(f"Client {client_id} connected")

#         # Send the assignment only to the specific client
#         socketio.emit('client_assigned', {'client_id': client_id}, room=request.sid)
